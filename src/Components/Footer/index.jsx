                ...
                <div className="content" style={{ opacity: 1 }}>
                            ...
                            <a href="/"
                                ...
                                <div className="btn-offer__arrow-wrap">
                                    <img
                                        ...
                                        loading="eager" width="16" alt="" className="btn-offer__arrow" />
                                    <img
                                        src="https://uploads-ssl.webflow.com/61e04ec7cf303307d55e03ce/61e04ec7cf303330ff5e03f3_ico_arrow.svg"
                                        loading="eager" width="16" alt="" className="btn-offer__arrow mod--over" />
                                </div>
                            </a>
                        </div>
                    </div>
                    <div className="footer__columns mod--top">
                        <div className="footer__col mod--1">
                            <div data-hover="false" className="footer__drop w-dropdown">
                                <div className="footer__drop-btn w-dropdown-toggle" id="w-dropdown-toggle-0" role="button" tabIndex={0}>
                                ...
                                <nav className="footer__drop-list w-dropdown-list" id="w-dropdown-list-1"
                                    ...
                                    <ul className="footer__list">
                                        <li className="footer__list-item">
                                            <a href="#Big-transfers" data-anim="link"
                                        ...
                                        <li className="footer__list-item">
                                            <a href="#Processes" data-anim="link" className="footer__nav-link w-inline-block" tabIndex={0}>
                                                <div className="nav-txt-anim">
                                        ...
                                        <li className="footer__list-item">
                                        <a href="#Benefits" data-anim="link"
                        ...
                        <div className="footer__col mod--3">
                            <div data-hover="false" className="footer__drop w-dropdown">
                                <div className="footer__drop-btn w-dropdown-toggle" id="w-dropdown-toggle-2"
                                    aria-controls="w-dropdown-list-2" tabIndex={0}>
                                    <div className="footer__drop-arrow"></div>
                    ...
                    <div className="footer__columns mod--bottom">
                        <div className="footer__col mod--1 mod--bottom">
                            <a href="https://www.halo-lab.com/" target="_blank" rel="noreferrer"
                                className="footer__copyright w-inline-block">
                                    <img
                        ...
                        <div className="footer__col mod--3 mod--bottom">
                            <div data-hover="false" data-delay="0" className="droplang w-dropdown">
                                <div className="droplang__btn w-dropdown-toggle" id="w-dropdown-toggle-3"
                                    aria-controls="w-dropdown-list-3" tabIndex={0} style={{ opacity: 0.7 }}>
