        ...
        <section id="Benefits" className="section mod--work">
            <div data-w-id="23aa82da-d192-8dd9-fd6c-34b1289acbf1" className="content">
                ...
                <div data-swiper="work"
                    ...
                    <div className="swiper-wrapper" id="swiper-wrapper-395559f03d2195db">
                        <div className="swiper-slide mod--work swiper-slide-active"
                            style={{ opacity: 1, width: '386.667px', marginRight: '40px' }}
                        >
                            <div className="work__card">
                                ...
                                <p className="work__p">
                                    You can download documents in different file formats, import files to
                                    Evernote
                                </p>
                            </div>
                        </div>
                        <div className="swiper-slide mod--work swiper-slide-next"
                            style={{ opacity: 1, width: '386.667px', marginRight: '40px' }}>
                            <div className="work__card">
                                <div className="work__ico-wrap">
                                    <div className="work__ico-anim">
                        ...
                        <div className="swiper-slide mod--work"
                            style={{ opacity: 1, width: '386.667px', marginRight: '40px' }}>
                            <div className="work__card">
                                <div className="work__ico-wrap">
                                    <div className="work__ico-anim">
